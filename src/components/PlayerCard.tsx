...
const getXPFromKills = (kills: number) =>
  kills * XP_PER_KILL;
  ...
  return (
    ...
    >
      ...
      {isLive && (
        ...
        <div className="absolute top-3 right-3 z-10 bg-red-500/90 backdrop-blur-sm rounded-full px-2.5 py-0.5 text-[10px] font-bold text-white flex items-center gap-1.5 border border-red-400/30 shadow-lg shadow-red-500/20">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-white/5">
          ...
          <div className="text-center">
            ...
            <p className="text-cyan-400 font-bold text-sm">
              {player.stats.missions.toLocaleString()}
            </p>
