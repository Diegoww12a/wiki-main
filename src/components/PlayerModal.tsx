...
export default function PlayerModal({
  ...
  const xp =
    getXPFromKills(player.stats.kills);
        ...
        <div className="px-6 pb-6">
          ...
          {player.kickChannel && (
            ...
            <div className="bg-white/[0.03] border border-white/5 rounded-xl p-3 mb-4 flex items-center justify-between">
              ...
              <a
                href={`https://kick.com/${player.kickChannel}`}
                target="_blank"
          ...
          <div className="bg-white/[0.03] border border-white/5 rounded-xl p-4 mb-4">
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-yellow-300 text-xs font-medium uppercase tracking-wider">
                  Level
                </span>
