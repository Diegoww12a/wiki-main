...
export default function PlayersPage({
  ...
  const [sortBy, setSortBy] =
    useState<'name' | 'level' | 'reputation' | 'kd'>(
      'reputation'
    );
  ...
  const selectClass =
    "w-full [&>option]:bg-[#111116] bg-white/[0.03] border border-white/10 rounded-xl px-3 py-2.5 text-white text-sm focus:border-purple-500/50 outline-none transition-all appearance-none cursor-pointer";
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          ...
          <div>
            ...
            >
              ...
              {sortOrder === 'asc'
                ...
                : <SortDesc className="w-4 h-4 text-purple-400" />}
          ...
          <div>
            ...
            <select
              ...
              onChange={e =>
                setFilterTag(
                  e.target.value as typeof filterTag
                )
              }
              className={selectClass}
            >
